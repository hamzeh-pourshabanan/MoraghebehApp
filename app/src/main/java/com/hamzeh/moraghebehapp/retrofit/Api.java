...
public interface Api {
    ...
    @GET("/moraghebe/wp-json/moraghebeh/v1/login/")
    Call<LoginInfo> userInfo(
            @Query("user") String user,
            @Query("pass") String pass
    );

    @GET("/moraghebe/wp-json/moraghebeh/v1/manageArbayiin")
     ...
     */
    @GET("/moraghebe/wp-json/moraghebeh/v1/getResults")
     ...
     */
    @POST("/moraghebe/wp-json/moraghebeh/v1/manageAmal/")
